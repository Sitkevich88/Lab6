...
/**
    ...
    private UserData authorise(){
        ...
        UserAuthorisation userAuthorisater = new UserAuthorisation();
        while (!successful){
            userData =  userAuthorisater.requestAuthorisationFromClient();
            try {
            ...
            userAuthorisater.loadAuthResultFromClient(successful);
        }
        return userData;
    }
...
/**
    ...
    public void sendRequest() {
        ...
        ServerRequest request = requestsFactory.getRequest();
